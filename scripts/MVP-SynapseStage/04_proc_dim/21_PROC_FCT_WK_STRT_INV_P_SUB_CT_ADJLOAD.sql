...
CREATE PROC [ETL].[PROC_FCT_WK_STRT_INV_P_SUB_CT_ADJLOAD] AS
...
DECLARE @ERROR_PROCEDURE_NAME AS VARCHAR(60) = 'ETL.PROC_FCT_WK_STRT_INV_P_SUB_CT_ADJLOAD' ;
...
EXEC ETL.AUDIT_DATA_LOAD_START
 @EXEC_LYR  = 'DM'
,@EXEC_JOB  = 'PROC_FCT_WK_STRT_INV_P_SUB_CT_ADJLOAD'
,@SRC_ENTY  = 'WK_UT_MPRS_CT_HST_ADJ'
...
FROM   stg.wk_ut_mprs_ct_hst_ADJ AS aa
       INNER JOIN (
	   ...
	   SELECT pky_id, mprs_ct_id, mjr_p_sub_ct_id
               ...
               ON CAST(b.pky_id as smallint) = CAST(aa.pky_id as smallint)
                  AND CAST(b.mprs_ct_id as smallint) = CAST(aa.mprs_catg_id as smallint)
...
update DM.FCT_WK_STRT_INV_P_SUB_CT  SET
	 TG_INV_CST_AM = TARGET.TG_INV_CST_AM + SOURCE.TG_INV_CST_AM,
	TG_CLRN_INV_CST_AM = TARGET.TG_CLRN_INV_CST_AM + SOURCE.TG_CLRN_INV_CST_AM,
    INV_CLRN_QTY = TARGET.INV_CLRN_QTY + SOURCE.INV_CLRN_QTY ,
    TG_INV_QT = TARGET.TG_INV_QT + SOURCE.TG_INV_QT,
