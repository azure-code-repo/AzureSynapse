CREATE PROC [ETL].[PROC_FCT_WK_STRT_INV_P_SUB_CT_WK_DC_ADJLOAD] AS
...
DECLARE @ERROR_PROCEDURE_NAME AS VARCHAR(60) = 'ETL.PROC_FCT_WK_STRT_INV_P_SUB_CT_WK_DC_ADJLOAD' ;
...
EXEC ETL.AUDIT_DATA_LOAD_START
 @EXEC_LYR  = 'DM'
,@EXEC_JOB  = 'PROC_FCT_WK_STRT_INV_P_SUB_CT_WK_DC_ADJLOAD'
,@SRC_ENTY  = 'WK_DC_MPRS_CT_HST_ADJ'
...
FROM   stg.wk_dc_mprs_ct_hst_ADJ AS aa
       INNER JOIN (
