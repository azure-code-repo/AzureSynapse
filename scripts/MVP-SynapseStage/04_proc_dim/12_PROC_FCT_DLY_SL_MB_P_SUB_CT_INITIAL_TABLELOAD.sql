...
CREATE PROC [ETL].[PROC_FCT_DLY_SL_MB_P_SUB_CT_INITIAL_TABLELOAD] AS
...
EXEC ETL.AUDIT_DATA_LOAD_START
 @EXEC_LYR  = 'DM'
,@EXEC_JOB  = 'PROC_FCT_DLY_SL_MB_P_SUB_CT_INITIAL_TABLELOAD'
,@SRC_ENTY  = 'DLY_MJR_P_SUB_CT_SL_HST INITIAL'
...
FROM  STG_EDW.DLY_MJR_P_SUB_CT_SL_HST
...
FROM STG_EDW.DLY_MJR_P_SUB_CT_SL_HST AS A
...
WHERE A.DAY_DT    BETWEEN @PROCESSINGDAY AND @PROCESSINGENDDATE
-- WHERE A.DAY_DT    BETWEEN '2020-02-01' AND '2020-09-08'
GROUP BY
...
BEGIN CATCH
DECLARE @ERROR_PROCEDURE_NAME AS VARCHAR(60) = '[ETL].[PROC_FCT_DLY_SL_MB_P_SUB_CT_INITIAL_TABLELOAD]'
