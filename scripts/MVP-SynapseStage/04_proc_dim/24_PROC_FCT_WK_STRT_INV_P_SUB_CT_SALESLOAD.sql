CREATE PROC [ETL].[PROC_FCT_WK_STRT_INV_P_SUB_CT_SALESLOAD] AS
...
DECLARE @ERROR_PROCEDURE_NAME AS VARCHAR(60) = 'ETL.PROC_FCT_WK_STRT_INV_P_SUB_CT_SALESLOAD' ;
...
EXEC ETL.AUDIT_DATA_LOAD_START
 @EXEC_LYR  = 'DM'
,@EXEC_JOB  = 'PROC_FCT_WK_STRT_INV_P_SUB_CT_SALESLOAD'
,@SRC_ENTY  = 'WK_UT_MPRS_CT_HST_Sales'
...
FROM   stg.wk_ut_mprs_ct_hst_Sales AS aa
       INNER JOIN (
