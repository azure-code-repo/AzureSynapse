CREATE VIEW [V_EDAA_PRES].[FCT_HRLY_STR_ITMSKU_TY_LY_FUEL_SLS]
AS
WITH CTE
AS
(
      SELECT
        ...
        0 AS [LY_SLS_QTY],
        PRM_TO_SLS_DRCT_MGN_AMT AS [TY_DRCT_MGN_AMT],
        0 AS [LY_DRCT_MGN_AMT],
		b.FSC_YR
      FROM [EDAA_DW].[FCT_HRLY_STR_ITMSKU_TY_LY_FUEL_SLS] (NOLOCK) AS a
      ...
      SELECT
        ...
        PRM_TO_SLS_DRCT_MGN_AMT AS [LY_DRCT_MGN_AMT],
		b.FSC_YR
      FROM [EDAA_DW].[FCT_HRLY_STR_ITMSKU_TY_LY_FUEL_SLS] (NOLOCK) AS a
      INNER JOIN edaa_dw.dim_dly_cal b
