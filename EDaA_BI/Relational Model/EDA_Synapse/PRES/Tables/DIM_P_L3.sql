...
GO
CREATE NONCLUSTERED INDEX [DIM_P_L3_FNC_MPRS_CT_ID_NCIDX]
    ON [PRES].[DIM_P_L3]([FNC_MPRS_CT_ID] ASC);


GO
CREATE NONCLUSTERED INDEX [DIM_P_L3_P_SUB_CT_ID_NCIDX]
    ON [PRES].[DIM_P_L3]([P_SUB_CT_ID] ASC);
