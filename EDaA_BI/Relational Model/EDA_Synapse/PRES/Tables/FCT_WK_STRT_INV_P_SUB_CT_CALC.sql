CREATE TABLE [PRES].[FCT_WK_STRT_INV_P_SUB_CT_CALC] (
    ...
    CONSTRAINT [PK_FCT_WK_STRT_INV_P_SUB_CT_CALC] PRIMARY KEY NONCLUSTERED ([GEO_HST_SKY] ASC, [TM_SKY] ASC, [P_HST_SKY] ASC) NOT ENFORCED
)
