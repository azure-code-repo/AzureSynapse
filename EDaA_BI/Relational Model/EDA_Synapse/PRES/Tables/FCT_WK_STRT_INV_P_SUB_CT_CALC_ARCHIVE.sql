...
CREATE TABLE [PRES].[FCT_WK_STRT_INV_P_SUB_CT_CALC_ARCHIVE] (
    ...
    [TG_INV_CST_AM]                         DECIMAL (11, 2) NULL,
    [TG_CLRN_INV_CST_AM]                    DECIMAL (11, 2) NULL,
    [INV_CLRN_QTY]                          INT             NULL,
    [TG_INV_QT]                             INT             NULL,
    [TG_INV_CST_AM_LY_CLDR]                 DECIMAL (11, 2) NULL,
    [TG_CLRN_INV_CST_AM_LY_CLDR]            DECIMAL (11, 2) NULL,
    [INV_CLRN_QTY_LY_CLDR]                  INT             NULL,
    [TG_INV_QTY_LY_CLDR]                    INT             NULL,
    [TG_INV_CST_AM_LY_FSC]                  DECIMAL (11, 2) NULL,
    [TG_CLRN_INV_CST_AM_LY_FSC]             DECIMAL (11, 2) NULL,
    [INV_CLRN_QTY_LY_FSC]                   INT             NULL,
    [TG_INV_QTY_LY_FSC]                     INT             NULL,
    [TG_INV_CST_AM_LY_HLDY]                 DECIMAL (11, 2) NULL,
    [TG_CLRN_INV_CST_AM_LY_HLDY]            DECIMAL (11, 2) NULL,
    [INV_CLRN_QTY_LY_HLDY]                  INT             NULL,
    [TG_INV_QTY_LY_HLDY]                    INT             NULL,
    [TG_INV_CST_AM_DIFF_TY_VS_LY_CLDR]      DECIMAL (11, 2) NULL,
    [TG_CLRN_INV_CST_AM_DIFF_TY_VS_LY_CLDR] DECIMAL (11, 2) NULL,
    [INV_CLRN_QTY_DIFF_TY_VS_LY_CLDR]       INT             NULL,
    [TG_INV_QTY_DIFF_TY_VS_LY_CLDR]         INT             NULL,
    [TG_INV_CST_AM_DIFF_TY_VS_LY_FSC]       DECIMAL (11, 2) NULL,
    [TG_CLRN_INV_CST_AM_DIFF_TY_VS_LY_FSC]  DECIMAL (11, 2) NULL,
    [INV_CLRN_QTY_DIFF_TY_VS_LY_FSC]        INT             NULL,
    [TG_INV_QTY_DIFF_TY_VS_LY_FSC]          INT             NULL,
    [TG_INV_CST_AM_DIFF_TY_VS_LY_HLDY]      DECIMAL (11, 2) NULL,
    [TG_CLRN_INV_CST_AM_DIFF_TY_VS_LY_HLDY] DECIMAL (11, 2) NULL,
    [INV_CLRN_QTY_DIFF_TY_VS_LY_HLDY]       INT             NULL,
    [TG_INV_QTY_DIFF_TY_VS_LY_HLDY]         INT             NULL,
    [IS_ATV]                                BIT             NOT NULL,
    ...
    CONSTRAINT [PK_FCT_WK_STRT_INV_P_SUB_CT_CALC_ARCH] PRIMARY KEY NONCLUSTERED ([GEO_HST_SKY] ASC, [TM_SKY] ASC, [P_HST_SKY] ASC) NOT ENFORCED
    -- Build added
)
