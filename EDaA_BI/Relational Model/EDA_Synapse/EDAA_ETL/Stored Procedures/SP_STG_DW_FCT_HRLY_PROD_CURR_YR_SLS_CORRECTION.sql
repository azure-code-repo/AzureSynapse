CREATE PROC [EDAA_ETL].[SP_STG_DW_FCT_HRLY_PROD_CURR_YR_SLS_CORRECTION] AS

/*
 =============================================
 Author:        Shrikant Sakpal
 Create date:   30-May-2021
 Description:   Stored proc truncate and full load Hourly Product Current Year Sales DW table for correction.
 =============================================
 Change History
...
EXEC EDAA_CNTL.SP_AUDIT_DATA_LOAD_START
 @EXEC_LYR  = 'EDAA_DW'
,@EXEC_JOB  = 'SP_STG_DW_FCT_HRLY_PROD_CURR_YR_SLS_CORRECTION'
...
BEGIN CATCH
DECLARE @ERROR_PROCEDURE_NAME AS VARCHAR(60) = 'EDAA_ETL.SP_STG_DW_FCT_HRLY_PROD_CURR_YR_SLS_CORRECTION'
