CREATE PROC [EDAA_ETL].[PROC_FCT_RTL_DLY_SL_P_SUB_CT_TY_LY_DM_PRES_LOAD]
AS
BEGIN

    --exec [EDAA_ETL].[PROC_FCT_RTL_DLY_SL_P_SUB_CT_TY_LY_DM_PRES_LOAD]
    ...
    BEGIN TRY
        ...
        EXEC EDAA_CNTL.SP_AUDIT_DATA_LOAD_START @EXEC_LYR = 'EDAA_PRES',
                                                @EXEC_JOB = 'EDAA_ETL.PROC_FCT_RTL_DLY_SL_P_SUB_CT_TY_LY_DM_PRES_LOAD',
        ...
        --Truncate PRES Table For Full load
        TRUNCATE TABLE [EDAA_PRES].[FCT_RTL_DLY_SL_P_SUB_CT_TY_LY];

        -- Insert 2 years of data Into PRES table
    ...
    END TRY
    BEGIN CATCH
        DECLARE @ERROR_PROCEDURE_NAME AS varchar(60) = '[EDAA_ETL].[PROC_FCT_RTL_DLY_SL_P_SUB_CT_TY_LY_DM_PRES_LOAD]'
