/****** Object:  StoredProcedure [EDAA_ETL].[SP_STG_DW_FCT_MPRS_PRODUCT_RCV_SUMMARY_IPOP]    Script Date: 1/20/2023 4:31:12 AM ******/


CREATE PROC [EDAA_ETL].[SP_STG_DW_FCT_MPRS_PRODUCT_RCV_SUMMARY_IPOP] @From_DT_SK [INT],@TO_DT_SK [INT] AS
...
;WITH FCT_MPRS_PRODUCT_RCV_SUMMARY AS
(
SELECT *
FROM  EDAA_STG.FCT_MPRS_PRODUCT_RCV_SUMMARY
...
SELECT 	ISNULL(PROD.Prod_Hist_Sk,-1) AS Prod_Hist_Sk,
		...
		@GETDATETIME,
		@GETDATETIME
FROM  FCT_MPRS_PRODUCT_RCV_SUMMARY MPRS
