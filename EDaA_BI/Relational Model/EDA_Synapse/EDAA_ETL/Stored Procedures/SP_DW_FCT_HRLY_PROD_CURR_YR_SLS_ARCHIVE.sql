CREATE PROC [EDAA_ETL].[SP_DW_FCT_HRLY_PROD_CURR_YR_SLS_ARCHIVE] AS
/*
 =============================================
...
EXEC EDAA_CNTL.SP_AUDIT_DATA_LOAD_START
 @EXEC_LYR  = 'EDAA_DW'
,@EXEC_JOB  = 'SP_DW_FCT_HRLY_PROD_CURR_YR_SLS_ARCHIVE'
,@SRC_ENTY  = 'FCT_HRLY_PROD_CURR_YR_SLS'
,@TGT_ENTY = 'FCT_HRLY_PROD_CURR_YR_SLS_ARCHIVE'
,@NEW_AUD_SKY = @NEW_AUD_SKY OUTPUT
;


INSERT INTO EDAA_DW.FCT_HRLY_PROD_CURR_YR_SLS_ARCHIVE(
	   Dt_Tm_Hr
      ,Geo_Hist_Sk
      ,Prod_Hist_Sk
      ,Dt_Sk
  ...
  TRUNCATE TABLE EDAA_DW.FCT_HRLY_PROD_CURR_YR_SLS;
  TRUNCATE TABLE EDAA_STG.FCT_HRLY_PROD_CURR_YR_SLS;
  TRUNCATE TABLE EDAA_STG.FCT_HRLY_PROD_CURR_YR_SLS_TEMP;
...
BEGIN CATCH
DECLARE @ERROR_PROCEDURE_NAME AS VARCHAR(60) = 'EDAA_ETL.SP_DW_FCT_HRLY_PROD_CURR_YR_SLS_ARCHIVE'
