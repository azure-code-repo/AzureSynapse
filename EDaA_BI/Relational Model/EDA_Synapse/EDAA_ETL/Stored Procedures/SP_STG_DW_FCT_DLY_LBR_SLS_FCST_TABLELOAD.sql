CREATE PROC [EDAA_ETL].[SP_STG_DW_FCT_DLY_LBR_SLS_FCST_TABLELOAD] AS

/*
 =============================================
 Author:        Krishna Kumar Shaw
 Create date:   20-Apr-2021
 Description:   Stored proc truncate and load Hourly Sales Labour Forecast table.
 =============================================
 Change History
...
EXEC EDAA_CNTL.SP_AUDIT_DATA_LOAD_START
 @EXEC_LYR  = 'EDAA_DW'
,@EXEC_JOB  = 'SP_STG_DW_FCT_DLY_LBR_SLS_FCST_TABLELOAD'
...
BEGIN CATCH
DECLARE @ERROR_PROCEDURE_NAME AS VARCHAR(60) = 'EDAA_ETL.SP_STG_DW_FCT_DLY_LBR_SLS_FCST_TABLELOAD'
