CREATE PROC [EDAA_ETL].[PROC_FCT_DLY_STR_ITMSKU_SLS_ADJ_DM_TO_PRES_LOAD]
AS
BEGIN
  BEGIN TRY
    ...
    EXEC EDAA_CNTL.SP_AUDIT_DATA_LOAD_START @EXEC_LYR = 'EDAA_DW',
                                            @EXEC_JOB = 'PROC_FCT_DLY_STR_ITMSKU_SLS_ADJ_DM_TO_PRES_LOAD',
                                            @SRC_ENTY = 'FCT_DLY_STR_ITMSKU_SLS_ADJ',
                                            @TGT_ENTY = 'FCT_DLY_STR_ITMSKU_SLS_ADJ_TY_LY_FSC',
                                            @NEW_AUD_SKY = @NEW_AUD_SKY OUTPUT

    --TRUNCATE Tables
    TRUNCATE TABLE [EDAA_STG].[STG_FCT_DLY_STR_ITMSKU_SLS_ADJ_TY_LY_FSC];
	TRUNCATE TABLE [EDAA_PRES].[FCT_DLY_STR_ITMSKU_SLS_ADJ_TY_LY_FSC];
    ...
    INSERT INTO [EDAA_STG].[STG_FCT_DLY_STR_ITMSKU_SLS_ADJ_TY_LY_FSC] ([DT_SK]
    , [LY_DT_SK]
    , [LY_DT_SK_HLDY]
    , [LY_DT_SK_CAL]
    , [ITM_SKU]
    ...
    INSERT INTO [EDAA_PRES].[FCT_DLY_STR_ITMSKU_SLS_ADJ_TY_LY_FSC]
	(
	DT_SK,
    LY_DT_SK,
    LY_DT_SK_HLDY,
    ...
    UPDATEDTIMESTAMP
      ...
      SELECT
        ...
        SUM(x.SLS_ADJ_AMT_LY_FSC) AS SLS_ADJ_AMT_LY_FSC,
    ...
    --EXECUTE SP_AUDIT_DATA_LOAD_END
  ...
  BEGIN CATCH
    DECLARE @ERROR_PROCEDURE_NAME AS varchar(60) = '[EDAA_ETL].[PROC_FCT_DLY_STR_ITMSKU_SLS_ADJ_DM_TO_PRES_LOAD]'
