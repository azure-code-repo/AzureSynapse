CREATE VIEW [ETL].[V_SRC_FCT_DLY_SL_P_SUB_CT_INCR_LY_HLDY] AS select
...
SUM(FCT_HLDY.SLS_FNC_AM) AS SLS_FNC_AM_LY_HLDY,
SUM(FCT_HLDY.SLS_FNC_QTY) AS SLS_FNC_QTY_LY_HLDY,
SUM(FCT_HLDY.DM_FNC_AM) AS DM_FNC_AM_LY_HLDY,
SUM(FCT_HLDY.DM_FNC_CLRN_AM) AS DM_FNC_CLRN_AM_LY_HLDY,
SUM(FCT_HLDY.DM_FNC_PROMO_AM) AS DM_FNC_PROMO_AM_LY_HLDY,
SUM(FCT_HLDY.SLS_FNC_CLRN_AM) AS SLS_FNC_CLRN_AM_LY_HLDY,
SUM(FCT_HLDY.SLS_FNC_CLRN_MKDN_AM) AS SLS_FNC_CLRN_MKDN_AM_LY_HLDY,
SUM(FCT_HLDY.SLS_FNC_PROMO_AM) AS SLS_FNC_PROMO_AM_LY_HLDY,
SUM(FCT_HLDY.SLS_FNC_PROMO_MKDN_AM) AS SLS_FNC_PROMO_MKDN_AM_LY_HLDY,
SUM(FCT_HLDY.SLS_FNC_CLRN_QTY) AS SLS_FNC_CLRN_QTY_LY_HLDY,
SUM(FCT_HLDY.SLS_FNC_SCN_QTY) AS SLS_FNC_SCN_QTY_LY_HLDY,
SUM(FCT_HLDY.SLS_FNC_AM_COMP) AS SLS_FNC_AM_COMP_LY_HLDY,
SUM(FCT_HLDY.SLS_FNC_AM_NCOMP) AS SLS_FNC_AM_NCOMP_LY_HLDY,
SUM(FCT_HLDY.INV_SHRK_AM) AS INV_SHRK_AM_LY_HLDY,
SUM(FCT_HLDY.INV_CLRN_QTY) AS INV_CLRN_QTY_LY_HLDY,
SUM(FCT_HLDY.SLS_FNC_AM) - SUM(FCT_HLDY.DM_FNC_AM) as COGS_FNC_LY_HLDY,
(SUM(FCT_HLDY.DM_FNC_AM) - SUM(FCT_HLDY.DM_FNC_PROMO_AM) ) - SUM(FCT_HLDY.DM_FNC_CLRN_AM) as DM_FNC_RRTL_AM_LY_HLDY,
SUM(FCT_HLDY.SLS_FNC_PROMO_MKDN_AM) + SUM(FCT_HLDY.SLS_FNC_CLRN_MKDN_AM) as SLS_FNC_MKDN_AM_LY_HLDY,
(SUM(FCT_HLDY.SLS_FNC_AM) - sum(FCT_HLDY.SLS_FNC_PROMO_AM)) - SUM(FCT_HLDY.SLS_FNC_CLRN_AM) as SLS_FNC_RRTL_MKDN_AM_LY_HLDY,
(SUM(FCT_HLDY.SLS_FNC_AM) - SUM(FCT_HLDY.SLS_FNC_CLRN_AM)) AS SLS_FNC_NCLRN_AM_LY_HLDY,
(SUM(FCT_HLDY.DM_FNC_AM) - SUM(FCT_HLDY.DM_FNC_CLRN_AM)) AS DM_FNC_NCLRN_AM_LY_HLDY
from DM.FCT_DLY_SL_P_SUB_CT AS FCT_HLDY
...
ON  FCT_HLDY.TM_SKY = TM.TM_SKY_LY_HLDY
 ...
 --AND
 --BYR.mjr_p_sub_ct_id = FCT_HLDY.p_sub_ct_id
...
--) AS INCR
--ON INCR.UT_ID = FCT_HLDY.UT_ID  AND INCR.P_SUB_CT_ID = FCT_HLDY.P_SUB_CT_ID
--AND INCR.TM_SKY = FCT_HLDY.TM_SKY AND INCR.FNC_MPRS_CT_ID = BYR.curr_mprs_ct_id
