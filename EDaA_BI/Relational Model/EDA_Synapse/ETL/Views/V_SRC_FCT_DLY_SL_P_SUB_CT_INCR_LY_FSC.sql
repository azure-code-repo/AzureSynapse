CREATE VIEW [ETL].[V_SRC_FCT_DLY_SL_P_SUB_CT_INCR_LY_FSC] AS select
...
SUM(FCT_FSC.SLS_FNC_AM) AS SLS_FNC_AM_LY_FSC,
SUM(FCT_FSC.SLS_FNC_QTY) AS SLS_FNC_QTY_LY_FSC,
SUM(FCT_FSC.DM_FNC_AM) AS DM_FNC_AM_LY_FSC,
SUM(FCT_FSC.DM_FNC_CLRN_AM) AS DM_FNC_CLRN_AM_LY_FSC,
SUM(FCT_FSC.DM_FNC_PROMO_AM) AS DM_FNC_PROMO_AM_LY_FSC,
SUM(FCT_FSC.SLS_FNC_CLRN_AM) AS SLS_FNC_CLRN_AM_LY_FSC,
SUM(FCT_FSC.SLS_FNC_CLRN_MKDN_AM) AS SLS_FNC_CLRN_MKDN_AM_LY_FSC,
SUM(FCT_FSC.SLS_FNC_PROMO_AM) AS SLS_FNC_PROMO_AM_LY_FSC,
SUM(FCT_FSC.SLS_FNC_PROMO_MKDN_AM) AS SLS_FNC_PROMO_MKDN_AM_LY_FSC,
SUM(FCT_FSC.SLS_FNC_CLRN_QTY) AS SLS_FNC_CLRN_QTY_LY_FSC,
SUM(FCT_FSC.SLS_FNC_SCN_QTY) AS SLS_FNC_SCN_QTY_LY_FSC,
SUM(FCT_FSC.SLS_FNC_AM_COMP) AS SLS_FNC_AM_COMP_LY_FSC,
SUM(FCT_FSC.SLS_FNC_AM_NCOMP) AS SLS_FNC_AM_NCOMP_LY_FSC,
SUM(FCT_FSC.INV_SHRK_AM) AS INV_SHRK_AM_LY_FSC,
SUM(FCT_FSC.INV_CLRN_QTY) AS INV_CLRN_QTY_LY_FSC,
SUM(FCT_FSC.SLS_FNC_AM) - SUM(FCT_FSC.DM_FNC_AM) as COGS_FNC_LY_FSC,
(SUM(FCT_FSC.DM_FNC_AM) - SUM(FCT_FSC.DM_FNC_PROMO_AM) ) - SUM(FCT_FSC.DM_FNC_CLRN_AM) as DM_FNC_RRTL_AM_LY_FSC,
SUM(FCT_FSC.SLS_FNC_PROMO_MKDN_AM) + SUM(FCT_FSC.SLS_FNC_CLRN_MKDN_AM) as SLS_FNC_MKDN_AM_LY_FSC,
(SUM(FCT_FSC.SLS_FNC_AM) - sum(FCT_FSC.SLS_FNC_PROMO_AM)) - SUM(FCT_FSC.SLS_FNC_CLRN_AM) as SLS_FNC_RRTL_MKDN_AM_LY_FSC,
(SUM(FCT_FSC.SLS_FNC_AM) - SUM(FCT_FSC.SLS_FNC_CLRN_AM)) AS SLS_FNC_NCLRN_AM_LY_FSC,
(SUM(FCT_FSC.DM_FNC_AM) - SUM(FCT_FSC.DM_FNC_CLRN_AM)) AS DM_FNC_NCLRN_AM_LY_FSC
from DM.FCT_DLY_SL_P_SUB_CT AS FCT_FSC
...
--) AS INCR
--ON INCR.UT_ID = FCT_FSC.UT_ID  AND INCR.P_SUB_CT_ID = FCT_FSC.P_SUB_CT_ID
