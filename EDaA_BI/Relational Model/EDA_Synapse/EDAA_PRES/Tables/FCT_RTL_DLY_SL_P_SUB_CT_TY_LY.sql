CREATE TABLE [EDAA_PRES].[FCT_RTL_DLY_SL_P_SUB_CT_TY_LY]
(
	[DT_SK] [int] NOT NULL,
	...
	[SLS_FNC_AM_LY_CAL] [decimal](11, 2) NULL,
	[SLS_FNC_QTY_LY_CAL] [int] NULL,
	[DM_FNC_AM_LY_CAL] [decimal](11, 2) NULL,
	[SLS_FNC_SCN_QTY_LY_CAL] [int] NULL,
 ...
 CONSTRAINT [PK_FCT_RTL_DLY_SL_P_SUB_CT] PRIMARY KEY NONCLUSTERED
	(
		[GEO_HST_SKY] ASC,
		[DT_SK] ASC,
		[P_HST_SKY] ASC
